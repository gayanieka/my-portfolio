...
const Contact = () => {
  return (
    <section id="contact" className="bg-gray-900 text-white py-20 border-t border-gray-800">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-10">
          ...
          <div className="flex gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="px-6 py-3 bg-gray-800 text-white font-bold rounded-full border border-gray-700 hover:bg-gray-700 transition-colors"
            >
              LinkedIn
            </a>
            <a
