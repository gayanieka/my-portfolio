...
const About = () => {
  const skills = [
    "Python", "R Language", "Power BI", "SQL", 
          ...
          <div className="flex-1 w-full">
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white p-8 rounded-[2rem] shadow-xl shadow-gray-100 flex flex-col justify-center items-center text-center transform transition-transform hover:-translate-y-2">
                <span className="text-5xl font-black text-primary mb-2">2x</span>
                <span className="text-gray-500 font-medium">Dean's List Awards</span>
              </div>
              <div className="bg-white p-8 rounded-[2rem] shadow-xl shadow-gray-100 flex flex-col justify-center items-center text-center transform transition-transform hover:-translate-y-2">
                <span className="text-5xl font-black text-primary mb-2">6+</span>
                <span className="text-gray-500 font-medium">Core Projects</span>
              </div>
              <div className="col-span-2 bg-gray-900 p-8 rounded-[2rem] shadow-xl shadow-gray-900/20 flex flex-col justify-center items-center text-center transform transition-transform hover:-translate-y-2">
